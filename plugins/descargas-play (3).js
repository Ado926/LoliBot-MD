...
*💙 ${await tr("Espere un momento en lo que envío su")} ${tipoDescarga}*`,  
contextInfo:{  
forwardedNewsletterMessageInfo: { 
newsletterJid: '120363402846939411@newsletter', 
serverMessageId: '', 
newsletterName: 'Abundantes Botsitos 👻' },
forwardingScore: 9,  
isForwarded: true,   
mentionedJid: null,  
externalAdReply: {  
...
handler.command = ['play2', 'play3', 'play4', 'audio', 'video', 'playdoc', 'playdoc2', 'musica'];
