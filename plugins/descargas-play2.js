...
if (!args[0]) throw `*${await tr("Que esta buscando?")}🤔 ${await tr("Ingrese el enlace de YouTube para empezar a descargar")}*`
...
m.reply([`*⌛ ${await tr("Espera...")} ✋ ${await tr("Un momento... Ya estoy descargando tu audio")}🍹*`, `⌛ ${await tr("PROCESANDO...")}\n*${await tr("Estoy intentando descargar tu audio espera")} 🏃‍♂️💨*`, `${await tr("Calmao pa estoy bucando tu canción")} \n\n*${await tr("Recuerda colocar bien el nombre de la cancion o el link del video de youtube")}*\n\n> *${await tr("Si el comando *ytmp3 no funciona utiliza el comando")} *#ytmp3doc*`].getRandom())  
try {
...
m.reply([`*⌛ ${await tr("Espera...")} ✋ ${await tr("Un momento... Ya estoy descargando tu video")} 🍹*`, `⌛ ${await tr("PROCESANDO...")}\n*${await tr("Estoy intentando descargar tu video espere")} 🏃‍♂️💨*`, `${await tr("Calma")} ✋🥸🤚\n\n*${await tr("Estoy descargando tu video ")} 🔄*\n\n> *${await tr("Aguarde un momento, por favor")}*`].getRandom())   
try {
